...
public class OauthDto { // oauth 회원 정보 담고 있는 dto
    ...
    public static OauthDto ofgoogle( String registrationId , String nameAttributeKey , Map<String, Object> attributes  ) {
        String mid = ( (String) attributes.get("email") ).split("@")[0];
        return OauthDto.builder()
                .mid(mid)
    ...
    public static OauthDto ofgithub( String registrationId , String nameAttributeKey , Map<String, Object> attributes  ) {

        return OauthDto.builder()
                .mid( (String)attributes.get("login") )
                .mname((String) attributes.get("name"))        // 요청변수 이름은 카카오 로그인 문서참고
                .memail((String) attributes.get("email"))
                .registrationId( registrationId )
                .attributes( attributes)
                .nameAttributeKey( nameAttributeKey )
